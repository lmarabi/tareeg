...
public class Request {
	...
	private enum exportType {
		...
		node, edge, unsortedNode, wkt,output,kml
	}
	...
	public void GetSmartOutput(String id, String minLon, String minLat,
		...
		String KMLHeader = "<kml xmlns=`http://www.opengis.net/kml/2.2` xmlns:atom=`http://www.w3.org/2005/Atom` xmlns:gx=`http://www.google.com/kml/ext/2.2` xmlns:kml=`http://www.opengis.net/kml/2.2`>".replace('`', '"');
	    String KMLTag = "\n <Document>\n  <name>KmlFile generated by TAREEG Extractor - Louai Alarabi</name>\n  <Folder>\n   <name>polygons</name>";
	    String KMLTagLine = "\n <Document>\n  <name>KmlFile generated by TAREEG Extractor- Louai Alarabi</name>\n  <Folder>\n   <name>lines</name>";
		this.outwriter = new OutputStreamWriter[exportType.values().length];
		exportPath += id + "/";
		File dir = new File(exportPath);
		...
		if (type.equals(dataType.road_edges)
			...
			this.outwriter[exportType.kml.ordinal()] = new OutputStreamWriter(
					new FileOutputStream(exportPath + exportType.kml.toString()
							+ ".KML"), "UTF-8");
			...
			this.outwriter[exportType.kml.ordinal()].write(KMLHeader + KMLTagLine);
			this.outwriter[exportType.wkt.ordinal()].write("edgeId"+"\t"+"geometry"+"\t"+"tags\n");
		}
		// add header in kml and well known text 
		...
		for (Partition f : files) {
			...
			if (type.equals(dataType.road_edges)
				...
				area.smartBuildNodeEdges(f,
						...
						outwriter[exportType.output.ordinal()], outwriter[exportType.kml.ordinal()]);
			} else {
		...
		if (type.equals(dataType.road_edges)
				|| type.equals(dataType.river_edges)) {
			outwriter[exportType.kml.ordinal()].write("\n  </Folder>" + "\n </Document>" + "\n</kml>");
			outwriter[exportType.kml.ordinal()].close();
